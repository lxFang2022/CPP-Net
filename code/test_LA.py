...
# from nets.net_factory import net_factory
...
parser.add_argument('--exp', type=str,  default='BCP_ours16', help='exp_name')
...
test_save_path = "./model/BCP/LA_{}_{}_labeled/{}_predictions2/".format(FLAGS.exp, FLAGS.labelnum, FLAGS.model)
num_classes = 2
...
def test_calculate_metric():
    model = BCP_net(net_type=FLAGS.model, in_chns=1, class_num=num_classes)
    # save_model_path = "./model/BCP/LA_BCP_ours19_24_labeled/self_train/iter_200_dice_0.821.pth"
